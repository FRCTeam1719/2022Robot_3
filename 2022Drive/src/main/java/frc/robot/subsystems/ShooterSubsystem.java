...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public static final double HighGoalShooterSpeed = 1250; // max speed based n testing
    public static final double MiddlePathShooterSpeed = 1250/*.8*/; // max speed based n testing
    public static final double LowGoalShooterSpeed = 1250/*.4*/;
